...
<body>
    ...
    <div class="container">
        ...
        <div class="contenuvus">
            ...
            <div class="menu2">
                <img src="./assets/images/Add Check Circle Icon.png" alt="">
                <h3>validation</h3>
            </div>
            <div class="menu3">
                <img src="./assets/images/Account Circle Icon.png" alt="">
                <h3>admition</h3>
            </div>
        </div>
    ...
    <div id="popover" class="popover" style="display: none;">
        <div class="containerpop">
            <button class="close-popover" onclick="closePopover()">×</button>
