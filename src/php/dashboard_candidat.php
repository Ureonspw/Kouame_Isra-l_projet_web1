...
<head>
    ...
    <div class="dashboard-container">
            ...
            <nav class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li data-section="concours">
                            <a href="#" data-target="concours"><i class="fas fa-trophy"></i> Sélectionner le concours</a>
                        </li>
                ...
                <div class="menu-section">
                    ...
                    <ul>
                        ...
                        <li data-section="emploi"><a href="#" data-target="emploi"><i class="fas fa-briefcase"></i> Emploi contractuel</a></li>
                        ...
                        <li data-section="permis"><a href="#" data-target="permis"><i class="fas fa-id-card"></i> Permis de conduire</a></li>
                    </ul>
                </div>
            </nav>
        ...
        <main class="main-content">
            ...
            <!-- Other Sections -->
            <div class="content-section" id="concours">
                <div class="content-header">
                    <h1>Sélectionner le concours</h1>
                </div>
                <div class="section-content">
                    <!-- Concours content will be loaded here -->
                </div>
            </div>
            ...
            <div class="content-section" id="types">
                ...
                <div class="section-content">
                    <!-- Types content will be loaded here -->
                    test
                </div>
            ...
            <div class="content-section" id="dossier">
                ...
                <div class="section-content">
                    <!-- Dossier content will be loaded here -->
                </div>
            </div>
            ...
            <div class="content-section" id="formations">
                ...
                <div class="section-content">
                    <!-- Formations content will be loaded here -->
                </div>
            </div>

            <div class="content-section" id="emploi">
                <div class="content-header">
                    <h1>Emploi contractuel</h1>
                </div>
                <div class="section-content">
                    <!-- Emploi content will be loaded here -->
                </div>
            </div>
