...
try {
    ...
    if (!isset($_POST['concours_id']) || !isset($_POST['date_ouverture']) || 
    ...
    $query = "INSERT INTO SESSION_CONCOURS (concours_id, date_ouverture, date_cloture, nb_places) 
              VALUES (:concours_id, :date_ouverture, :date_cloture, :nb_places)";
